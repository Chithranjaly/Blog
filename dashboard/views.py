...
def posts(request):
    ...
    return render(request, 'dashboards/blogposts.html', context)
...
def add_posts(request):
    ...
    return render(request, 'dashboards/addPost.html', context)
...
def edit_posts(request, pk):
    ...
    return render(request, 'dashboards/editPost.html', context)
...
def add_user(request):
    ...
    return render(request, 'dashboards/addUser.html', context)
...
def edit_user(request, pk):
    ...
    return render(request, 'dashboards/editUser.html', context)
